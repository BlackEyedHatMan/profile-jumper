...
describe('LibraryIcon Lib Utility', () => {
    ...
    test('should find icons for physical objects, not only brands', () => {
        // uses the default configured libraries, where fa6 fills object gaps in fa5
        expect(findIconNameTitle('car')).toEqual('FaCar')
        expect(findIconNameTitle('cat')).toEqual('FaCat')
        expect(findIconNameTitle('gun')).toEqual('FaGun')
        expect(findIconNameTitle('dog')).toEqual('FaDog')
        expect(findIconNameTitle('house')).toEqual('FaHouse')
        expect(findIconNameTitle('guitar')).toEqual('FaGuitar')
    })
    ...
    test('should find icon name for aliases as priority over icon library names', () => {
        ...
        expect(findIconNameTitle('bike', iconLibraries)).toEqual('FaBicycle')
        expect(findIconNameTitle('boat', iconLibraries)).toEqual('FaSailboat')
        ...
        expect(findIconNameTitle('cup', iconLibraries)).toEqual('FaMugHot')
        ...
        expect(findIconNameTitle('money', iconLibraries)).toEqual('FaMoneyBillWave')
        expect(findIconNameTitle('monitor', iconLibraries)).toEqual('FaDesktop')
        expect(findIconNameTitle('news', iconLibraries)).toEqual('FaNewspaper')
        expect(findIconNameTitle('plane', iconLibraries)).toEqual('FaPlane')
        expect(findIconNameTitle('rocket', iconLibraries)).toEqual('FaRocket')
        ...
        expect(findIconNameTitle('wine', iconLibraries)).toEqual('FaWineGlass')
    })
